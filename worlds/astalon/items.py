...
class Switch(StrEnum):
    ...
    GT_SWORD_ACCESS = "Door GT Sword Access"
    GT_SWORD_BACKTRACK = "Blocks GT Sword Backtrack"
    GT_SWORD = "Blocks GT Sword"
    GT_UPPER_ARIAS = "Door GT Upper Arias"
    ...
    MECH_UPPER_VOID_DROP = "Blocks Mech Upper Void Drop"
    MECH_UPPER_VOID = "Door Mech Upper Void"
    MECH_LINUS = "Door Mech Linus Lower"
    MECH_TO_BOSS_2 = "Door Mech To Boss"
    MECH_POTS = "Door Mech Pots"
    MECH_MAZE_BACKDOOR = "Blocks Mech Maze Backdoor"
    MECH_TO_BOSS_1 = "Blocks Mech To Boss Switches"
    MECH_BLOCK_STAIRS = "Blocks Mech Staircase Up"
    MECH_ARIAS_CYCLOPS = "Blocks Mech Arias Cyclops"
    MECH_BOOTS_LOWER = "Blocks Mech Boots Lower"
    MECH_CHAINS_GAP = "Blocks Mech Chains Gap"
    MECH_LOWER_KEY = "Door Mech Lower Key"
    MECH_ARIAS = "Door Mech Arias"
    MECH_SNAKE_2 = "Door Mech Snake Lower"
    MECH_KEY_BLOCKS = "Blocks Mech Key Cage"
    ...
    ROA_APEX_ACCESS = "Blocks RoA Apex Access"
    ROA_ICARUS = "Blocks RoA Icarus"
    ROA_SHAFT_L = "Blocks RoA Shaft Left"
    ROA_SHAFT_R = "Blocks RoA Shaft Right"
    ROA_ELEVATOR = "Blocks RoA Elevator"
    ROA_SHAFT_DOWNWARDS = "Blocks RoA Shaft Downwards"
    ROA_SPIDERS = "Blocks RoA Spiders Upper"
    ROA_DARK_ROOM = "Blocks RoA Dark Room"
    ROA_ASCEND_SHORTCUT = "Blocks RoA Ascend Shortcut"
    ROA_1ST_SHORTCUT = "Blocks RoA 1st Shortcut"
    ROA_SPIKE_CLIMB = "Door RoA Spike Climb"
    ROA_ABOVE_CENTAUR = "Blocks RoA Above Centaur"
    ROA_BLOOD_POT = "Blocks RoA Blood Pot"
    ROA_WORMS = "Door RoA Worms"
    ROA_TRIPLE_1 = "Blocks RoA Triple Left"
    ROA_TRIPLE_3 = "Door RoA Triple Right"
    ROA_BABY_GORGON = "Blocks RoA Baby Gorgon"
    ROA_BOSS_ACCESS = "Blocks RoA Boss Access"
    ROA_BLOOD_POT_L = "Door RoA Blood Pot Left"
    ROA_BLOOD_POT_R = "Door RoA Blood Pot Right"
    ROA_LOWER_VOID = "Door RoA Lower Void"
    DARKNESS = "Door Dark"
    APEX = "Blocks Apex"
    CAVES_SKELETONS = "Door Caves Skeletons"
    CAVES_CATA_1 = "Door Caves Cata Access 1"
    CAVES_CATA_2 = "Door Caves Cata Access 2"
    CAVES_CATA_3 = "Door Caves Cata Access 3"
    CATA_ELEVATOR = "Door Cata Elevator"
    CATA_VERTICAL_SHORTCUT = "Door Cata Vertical Shortcut"
    CATA_TOP = "Blocks Cata Top"
    CATA_CLAW_1 = "Door Cata Claw Right"
    CATA_CLAW_2 = "Door Cata Claw Left"
    CATA_WATER_1 = "Door Cata Water 1"
    CATA_WATER_2 = "Door Cata Water 2"
    CATA_DEV_ROOM = "Blocks Cata Dev Room"
    CATA_AFTER_BLUE_DOOR = "Blocks Cata After Blue Door"
    CATA_SHORTCUT_ACCESS = "Door Cata Shortcut Access"
    CATA_LADDER_BLOCKS = "Blocks Cata Ladder"
    CATA_MID_SHORTCUT = "Blocks Cata Mid Shortcut"
    CATA_1ST_ROOM = "Door Cata 1st Room"
    CATA_FLAMES_2 = "Blocks Cata Flames Left"
    CATA_FLAMES_1 = "Blocks Cata Flames Right"
    TR_ADORNED_L = "Door TR Adorned Left"
    TR_ADORNED_M = "Door TR Adorned Middle"
    TR_ADORNED_R = "Door TR Adorned Right"
    TR_ELEVATOR = "Door TR Elevator"
    TR_BOTTOM = "Blocks TR Bottom"
    CD_1 = "Door CD 1"
    CD_2 = "Blocks CD Backtrack 2"
    CD_3 = "Blocks CD 3"
    CD_CAMPFIRE = "Blocks CD Campfire"
    CD_TOP = "Blocks CD Top"
    CATH_BOTTOM = "Blocks Cath Bottom"
    CATH_BESIDE_SHAFT = "Blocks Cath Beside Shaft"
    CATH_TOP_CAMPFIRE = "Door Cath Top Campfire"
    SP_DOUBLE_DOORS = "Door SP Double"
    SP_BUBBLES = "Door SP Bubbles"
    SP_AFTER_STAR = "Door SP After Star"


class Crystal(StrEnum):
    GT_LADDER = "Door GT Ladder"
    GT_ROTA = "Door GT RotA"
    GT_OLD_MAN_1 = "Blocks GT Old Man 1"
    GT_OLD_MAN_2 = "Blocks GT Old Man 2"
    MECH_CANNON = "Door Mech Cannon Lower"
    MECH_LINUS = "Door Mech Linus Upper"
    MECH_LOWER = "Blocks Mech Lower"
    MECH_TO_BOSS_3 = "Blocks Mech Staircase To Boss"
    MECH_TRIPLE_1 = "Door Mech Triple 1"
    MECH_TRIPLE_2 = "Door Mech Triple 2"
    MECH_TRIPLE_3 = "Door Mech Triple 3"
    MECH_TOP = "Blocks Mech Top"
    MECH_CLOAK = "Door Mech Cloak"
    MECH_SLIMES = "Blocks Mech Slimes"
    MECH_TO_CD = "Blocks Mech To CD"
    MECH_CAMPFIRE = "Blocks Mech Campfire"
    ...
    ROA_LADDER_L = "Blocks RoA Ladder Left"
    ROA_CENTAUR = "Blocks RoA Centaur"
    ROA_SPIKE_BALLS = "Blocks RoA Spike Balls"
    ROA_LEFT_ASCEND = "Blocks RoA Left Ascend"
    ROA_SHAFT = "Blocks RoA Shaft"
    ROA_BRANCH_R = "Blocks RoA Branch Right"
    ROA_BRANCH_L = "Blocks RoA Branch Left"
    ROA_3_REAPERS = "Door RoA 3 Reapers"
    ROA_TRIPLE_2 = "Door RoA Triple Top"
    CATA_POISON_ROOTS = "Blocks Cata Poison Roots"
    TR_GOLD = "Blocks TR Gold"
    TR_DARK_ARIAS = "Blocks TR Dark Arias"
    CD_BACKTRACK = "Blocks CD Backtrack"
    CD_START = "Door CD Start"
    CD_CAMPFIRE = "Door CD Campfire"
    CD_STEPS = "Door CD Steps"
    CATH_1ST_ROOM = "Door Cath 1st Room"
    CATH_SHAFT = "Door Cath Shaft"
    CATH_SPIKE_PIT = "Door Cath Spike Pit"
    CATH_TOP_L = "Blocks Cath Top Left"
    CATH_TOP_R = "Blocks Cath Top Right"
    CATH_SHAFT_ACCESS = "Door Cath Shaft Access"
    CATH_ORBS = "Door Cath Orbs"
    SP_BLOCKS = "Blocks SP Shaft"
    SP_STAR = "Blocks SP Star"
...
class Face(StrEnum):
    ...
    CATA_AFTER_BOW = "Blocks Cata After Bow"
    CATA_BOW = "Blocks Cata Bow"
    CATA_X4 = "Door Cata x4 Faces"
    CATA_CAMPFIRE = "Blocks Cata Campfire"
    CATA_DOUBLE_DOOR = "Door Cata Double"
    CATA_BOTTOM = "Blocks Cata Bottom"
    CATH_L = "Blocks Cath Left"
    CATH_R = "Blocks Cath Right"
