...
class Switch(str, Enum):
    ...
    HOTP_ROCK = "Switch (Hall of the Phamtoms - Rock)"
    HOTP_BELOW_START = "Switch (Hall of the Phamtoms - Below Start)"
    HOTP_LEFT_2 = "Switch (Hall of the Phamtoms - Left 2)"
    HOTP_LEFT_1 = "Switch (Hall of the Phamtoms - Left 1)"
    HOTP_LOWER_SHORTCUT = "Switch (Hall of the Phamtoms - Lower Shortcut)"
    HOTP_BELL = "Switch (Hall of the Phamtoms - Bell)"
    HOTP_GHOST_BLOOD = "Switch (Hall of the Phamtoms - Ghost Blood)"
    HOTP_TELEPORTS = "Switch (Hall of the Phamtoms - Teleports)"
    HOTP_WORM_PILLAR = "Switch (Hall of the Phamtoms - Worm Pillar)"
    HOTP_TO_CLAW_1 = "Switch (Hall of the Phamtoms - To Claw 1)"
    HOTP_TO_CLAW_2 = "Switch (Hall of the Phamtoms - To Claw 2)"
    HOTP_CLAW_ACCESS = "Switch (Hall of the Phamtoms - Claw Access)"
    HOTP_GHOSTS = "Switch (Hall of the Phamtoms - Ghosts)"
    HOTP_LEFT_3 = "Switch (Hall of the Phamtoms - Left 3)"
    HOTP_ABOVE_OLD_MAN = "Switch (Hall of the Phamtoms - Above Old Man)"
    HOTP_TO_ABOVE_OLD_MAN = "Switch (Hall of the Phamtoms - To Above Old Man)"
    HOTP_TP_PUZZLE = "Switch (Hall of the Phamtoms - TP Puzzle)"
    HOTP_EYEBALL_SHORTCUT = "Switch (Hall of the Phamtoms - Eyeball Shortcut)"
    HOTP_BELL_ACCESS = "Switch (Hall of the Phamtoms - Bell Access)"
    HOTP_1ST_ROOM = "Switch (Hall of the Phamtoms - 1st Room)"
    HOTP_LEFT_BACKTRACK = "Switch (Hall of the Phamtoms - Left Backtrack)"
