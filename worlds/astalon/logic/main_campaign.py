...
MAIN_ENTRANCE_RULES: dict[tuple[R, R], RuleFactory] = {
    ...
    (R.ROA_TOP_CENTAUR, R.ROA_BOSS_CONNECTION): Or(
        ...
        CanReachRegion(R.ROA_CRYSTAL_ABOVE_CENTAUR, options=switch_off),
    ),
    ...
    (R.ROA_ABOVE_CENTAUR_R, R.ROA_CRYSTAL_ABOVE_CENTAUR): And(can_crystal_wo_whiplash, Has(KeyItem.BELL)),
