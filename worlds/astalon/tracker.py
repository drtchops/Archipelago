...
CAMPFIRE_WARPS: Final[dict[int, tuple[RegionName, str]]] = {
    ...
    5019: (RegionName.HOP_EPIMETHEUS, "HoP Epimetheus"),
    6421: (RegionName.HOP_BELL_CAMPFIRE, "HoP Bell"),
    3207: (RegionName.HOP_CLAW_CAMPFIRE, "HoP Claw"),
    2904: (RegionName.HOP_BOSS_CAMPFIRE, "HoP Boss"),
...
ELEVATORS: Final[dict[int, tuple[RegionName, str]]] = {
    ...
    10535: (RegionName.HOP_ELEVATOR, "Hall of Phantoms"),
    1080: (RegionName.HOP_BOSS, "Ruins of Ash 1"),
...
PORTAL_REGIONS: Final[dict[int, RegionName]] = {
    ...
    879: RegionName.HOP_LOWER_VOID,
    3264: RegionName.HOP_UPPER_VOID,
    7056: RegionName.HOP_CATH_VOID,
...
ACRONYMS = {
    ...
    "cath": "Cathedral, the orange side area off of Hall of Phantoms",
