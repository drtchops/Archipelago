...
location_table: Dict[Locations, AstalonLocationData] = {
    ...
    Locations.ROA_BLUE_KEY_POT: AstalonLocationData(Regions.ROA_TRIPLE_REAPER, LocationGroups.KEY_BLUE),
    ...
    Locations.HOTP_SWITCH_ROCK: AstalonLocationData(Regions.HOTP_AMULET_CONNECTION, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_BELOW_START: AstalonLocationData(Regions.HOTP_START_BOTTOM, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_LEFT_2: AstalonLocationData(Regions.HOTP_START_MID, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_LEFT_1: AstalonLocationData(Regions.HOTP_START_MID, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_LOWER_SHORTCUT: AstalonLocationData(Regions.HOTP_LOWER, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_BELL: AstalonLocationData(Regions.HOTP_BELL, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_GHOST_BLOOD: AstalonLocationData(Regions.HOTP_EYEBALL, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_TELEPORTS: AstalonLocationData(Regions.HOTP_LOWER_ARIAS, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_WORM_PILLAR: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_TO_CLAW_1: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_TO_CLAW_2: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_CLAW_ACCESS: AstalonLocationData(Regions.HOTP_CLAW_CAMPFIRE, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_GHOSTS: AstalonLocationData(Regions.HOTP_START_MID, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_LEFT_3: AstalonLocationData(Regions.HOTP_START_MID, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_ABOVE_OLD_MAN: AstalonLocationData(Regions.HOTP_ABOVE_OLD_MAN, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_TO_ABOVE_OLD_MAN: AstalonLocationData(Regions.HOTP_TOP_LEFT, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_TP_PUZZLE: AstalonLocationData(Regions.HOTP_TP_PUZZLE, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_EYEBALL_SHORTCUT: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_BELL_ACCESS: AstalonLocationData(Regions.HOTP_BELL_CAMPFIRE, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_1ST_ROOM: AstalonLocationData(Regions.HOTP_START, LocationGroups.SWITCH),
    Locations.HOTP_SWITCH_LEFT_BACKTRACK: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_ROCK_ACCESS: AstalonLocationData(Regions.HOTP_MECH_VOID_CONNECTION, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_BOTTOM: AstalonLocationData(Regions.HOTP_MECH_VOID_CONNECTION, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_LOWER: AstalonLocationData(Regions.HOTP_LOWER, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_AFTER_CLAW: AstalonLocationData(Regions.HOTP_CLAW_CAMPFIRE, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_MAIDEN_1: AstalonLocationData(Regions.HOTP_MAIDEN, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_MAIDEN_2: AstalonLocationData(Regions.HOTP_MAIDEN, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_BELL_ACCESS: AstalonLocationData(Regions.HOTP_BELL_CAMPFIRE, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_HEART: AstalonLocationData(Regions.HOTP_BOSS_CAMPFIRE, LocationGroups.SWITCH),
    Locations.HOTP_CRYSTAL_BELOW_PUZZLE: AstalonLocationData(Regions.HOTP_TP_FALL_TOP, LocationGroups.SWITCH),
    Locations.HOTP_FACE_OLD_MAN: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_ASCEND: AstalonLocationData(Regions.ROA_BOTTOM_ASCEND, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_AFTER_WORMS: AstalonLocationData(Regions.ROA_WORMS, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_RIGHT_PATH: AstalonLocationData(Regions.ROA_RIGHT_SWITCH_1, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_APEX_ACCESS: AstalonLocationData(Regions.ROA_APEX_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_ICARUS: AstalonLocationData(Regions.ROA_ELEVATOR, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_SHAFT_L: AstalonLocationData(Regions.ROA_MIDDLE_LADDER, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_SHAFT_R: AstalonLocationData(Regions.ROA_MIDDLE_LADDER, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_ELEVATOR: AstalonLocationData(Regions.ROA_ELEVATOR, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_SHAFT_DOWNWARDS: AstalonLocationData(Regions.ROA_SP_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_SPIDERS: AstalonLocationData(Regions.ROA_SPIDERS_2, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_DARK_ROOM: AstalonLocationData(Regions.ROA_ELEVATOR, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_ASCEND_SHORTCUT: AstalonLocationData(Regions.ROA_MIDDLE, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_1ST_SHORTCUT: AstalonLocationData(Regions.ROA_BOTTOM_ASCEND, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_SPIKE_CLIMB: AstalonLocationData(Regions.ROA_SPIKE_CLIMB, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_ABOVE_CENTAUR: AstalonLocationData(Regions.ROA_SP_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_BLOOD_POT: AstalonLocationData(Regions.ROA_CENTAUR, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_WORMS: AstalonLocationData(Regions.ROA_WORMS, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_TRIPLE_1: AstalonLocationData(Regions.ROA_TRIPLE_SWITCH, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_TRIPLE_3: AstalonLocationData(Regions.ROA_TRIPLE_SWITCH, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_BABY_GORGON: AstalonLocationData(Regions.ROA_ARIAS_BABY_GORGON, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_BOSS_ACCESS: AstalonLocationData(Regions.ROA_BOSS_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_BLOOD_POT_L: AstalonLocationData(Regions.ROA_BOSS_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_BLOOD_POT_R: AstalonLocationData(Regions.ROA_BOSS_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_SWITCH_LOWER_VOID: AstalonLocationData(Regions.ROA_LOWER_VOID, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_1ST_ROOM: AstalonLocationData(Regions.ROA_START, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_BABY_GORGON: AstalonLocationData(Regions.ROA_LOWER_VOID_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_LADDER_R: AstalonLocationData(Regions.ROA_RIGHT_SWITCH_2, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_LADDER_L: AstalonLocationData(Regions.ROA_LEFT_SWITCH, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_CENTAUR: AstalonLocationData(Regions.ROA_CENTAUR, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_SPIKE_BALLS: AstalonLocationData(Regions.ROA_UPPER_VOID, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_LEFT_ASCEND: AstalonLocationData(Regions.ROA_FLAMES_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_SHAFT: AstalonLocationData(Regions.ROA_SP_CONNECTION, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_BRANCH_R: AstalonLocationData(Regions.ROA_RIGHT_BRANCH, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_BRANCH_L: AstalonLocationData(Regions.ROA_RIGHT_BRANCH, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_3_REAPERS: AstalonLocationData(Regions.ROA_TRIPLE_REAPER, LocationGroups.SWITCH),
    Locations.ROA_CRYSTAL_TRIPLE_2: AstalonLocationData(Regions.ROA_TRIPLE_SWITCH, LocationGroups.SWITCH),
    Locations.ROA_FACE_SPIDERS: AstalonLocationData(Regions.ROA_SPIDERS_1, LocationGroups.SWITCH),
    Locations.ROA_FACE_BLUE_KEY: AstalonLocationData(Regions.ROA_BOTTOM_ASCEND, LocationGroups.SWITCH),
    Locations.DARK_SWITCH: AstalonLocationData(Regions.DARK_START, LocationGroups.SWITCH),
    Locations.APEX_SWITCH: AstalonLocationData(Regions.APEX, LocationGroups.SWITCH),
    Locations.CAVES_SWITCH_SKELETONS: AstalonLocationData(Regions.CAVES_UPPER, LocationGroups.SWITCH),
    Locations.CAVES_SWITCH_CATA_ACCESS_1: AstalonLocationData(Regions.CAVES_LOWER, LocationGroups.SWITCH),
    Locations.CAVES_SWITCH_CATA_ACCESS_2: AstalonLocationData(Regions.CAVES_LOWER, LocationGroups.SWITCH),
    Locations.CAVES_SWITCH_CATA_ACCESS_3: AstalonLocationData(Regions.CAVES_LOWER, LocationGroups.SWITCH),
    Locations.CAVES_FACE_1ST_ROOM: AstalonLocationData(Regions.CAVES_START, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_ELEVATOR: AstalonLocationData(Regions.CATA_TOP, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_SHORTCUT: AstalonLocationData(Regions.CATA_VERTICAL_SHORTCUT, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_TOP: AstalonLocationData(Regions.CATA_TOP, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_CLAW_1: AstalonLocationData(Regions.CATA_SNAKE_MUSHROOMS, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_CLAW_2: AstalonLocationData(Regions.CATA_SNAKE_MUSHROOMS, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_WATER_1: AstalonLocationData(Regions.CATA_DOUBLE_SWITCH, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_WATER_2: AstalonLocationData(Regions.CATA_DOUBLE_SWITCH, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_DEV_ROOM: AstalonLocationData(Regions.CATA_DEV_ROOM_CONNECTION, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_AFTER_BLUE_DOOR: AstalonLocationData(Regions.CATA_BLUE_EYE_DOOR, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_SHORTCUT_ACCESS: AstalonLocationData(Regions.CATA_FLAMES_FORK, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_LADDER_BLOCKS: AstalonLocationData(Regions.CATA_FLAMES_FORK, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_MID_SHORTCUT: AstalonLocationData(Regions.CATA_VERTICAL_SHORTCUT, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_1ST_ROOM: AstalonLocationData(Regions.CATA_START, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_FLAMES_2: AstalonLocationData(Regions.CATA_FLAMES_FORK, LocationGroups.SWITCH),
    Locations.CATA_SWITCH_FLAMES_1: AstalonLocationData(Regions.CATA_FLAMES_FORK, LocationGroups.SWITCH),
    Locations.CATA_CRYSTAL_POISON_ROOTS: AstalonLocationData(Regions.CATA_POISON_ROOTS, LocationGroups.SWITCH),
    Locations.CATA_FACE_AFTER_BOW: AstalonLocationData(Regions.CATA_BOW_CAMPFIRE, LocationGroups.SWITCH),
    Locations.CATA_FACE_BOW: AstalonLocationData(Regions.CATA_BOW, LocationGroups.SWITCH),
    Locations.CATA_FACE_X4: AstalonLocationData(Regions.CATA_4_FACES, LocationGroups.SWITCH),
    Locations.CATA_FACE_CAMPFIRE: AstalonLocationData(Regions.CATA_BOSS, LocationGroups.SWITCH),
    Locations.CATA_FACE_DOUBLE_DOOR: AstalonLocationData(Regions.CATA_DOUBLE_DOOR, LocationGroups.SWITCH),
    Locations.CATA_FACE_BOTTOM: AstalonLocationData(Regions.CATA_DOUBLE_DOOR, LocationGroups.SWITCH),
    Locations.TR_SWITCH_ADORNED_L: AstalonLocationData(Regions.TR_BOTTOM, LocationGroups.SWITCH),
    Locations.TR_SWITCH_ADORNED_M: AstalonLocationData(Regions.TR_LEFT, LocationGroups.SWITCH),
    Locations.TR_SWITCH_ADORNED_R: AstalonLocationData(Regions.TR_TOP_RIGHT, LocationGroups.SWITCH),
    Locations.TR_SWITCH_ELEVATOR: AstalonLocationData(Regions.CATA_BOSS, LocationGroups.SWITCH),
    Locations.TR_SWITCH_BOTTOM: AstalonLocationData(Regions.TR_MIDDLE_RIGHT, LocationGroups.SWITCH),
    Locations.TR_CRYSTAL_GOLD: AstalonLocationData(Regions.TR_TOP_RIGHT, LocationGroups.SWITCH),
    Locations.TR_CRYSTAL_DARK_ARIAS: AstalonLocationData(Regions.TD_DARK_ARIAS, LocationGroups.SWITCH),
    Locations.CD_SWITCH_1: AstalonLocationData(Regions.CD_START, LocationGroups.SWITCH),
    Locations.CD_SWITCH_2: AstalonLocationData(Regions.CD_2, LocationGroups.SWITCH),
    Locations.CD_SWITCH_3: AstalonLocationData(Regions.CD_3, LocationGroups.SWITCH),
    Locations.CD_SWITCH_CAMPFIRE: AstalonLocationData(Regions.CD_MIDDLE, LocationGroups.SWITCH),
    Locations.CD_SWITCH_TOP: AstalonLocationData(Regions.CD_TOP, LocationGroups.SWITCH),
    Locations.CD_CRYSTAL_BACKTRACK: AstalonLocationData(Regions.CD_2, LocationGroups.SWITCH),
    Locations.CD_CRYSTAL_START: AstalonLocationData(Regions.CD_START, LocationGroups.SWITCH),
    Locations.CD_CRYSTAL_CAMPFIRE: AstalonLocationData(Regions.CD_CAMPFIRE_3, LocationGroups.SWITCH),
    Locations.CD_CRYSTAL_STEPS: AstalonLocationData(Regions.CD_STEPS, LocationGroups.SWITCH),
    Locations.CATH_SWITCH_BOTTOM: AstalonLocationData(Regions.CATH_START_RIGHT, LocationGroups.SWITCH),
    Locations.CATH_SWITCH_BESIDE_SHAFT: AstalonLocationData(Regions.CATH_SHAFT_ACCESS, LocationGroups.SWITCH),
    Locations.CATH_SWITCH_TOP_CAMPFIRE: AstalonLocationData(Regions.CATH_TOP, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_1ST_ROOM: AstalonLocationData(Regions.CATH_START_TOP_LEFT, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_SHAFT: AstalonLocationData(Regions.CATH_LEFT_SHAFT, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_SPIKE_PIT: AstalonLocationData(Regions.CATH_TOP, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_TOP_L: AstalonLocationData(Regions.CATH_TOP, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_TOP_R: AstalonLocationData(Regions.CATH_TOP, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_SHAFT_ACCESS: AstalonLocationData(Regions.CATH_SHAFT_ACCESS, LocationGroups.SWITCH),
    Locations.CATH_CRYSTAL_ORBS: AstalonLocationData(Regions.CATH_ORB_ROOM, LocationGroups.SWITCH),
    Locations.CATH_FACE_LEFT: AstalonLocationData(Regions.CATH_START_LEFT, LocationGroups.SWITCH),
    Locations.CATH_FACE_RIGHT: AstalonLocationData(Regions.CATH_START_LEFT, LocationGroups.SWITCH),
    Locations.SP_SWITCH_DOUBLE_DOORS: AstalonLocationData(Regions.SP_HEARTS, LocationGroups.SWITCH),
    Locations.SP_SWITCH_BUBBLES: AstalonLocationData(Regions.SP_CAMPFIRE_1, LocationGroups.SWITCH),
    Locations.SP_SWITCH_AFTER_STAR: AstalonLocationData(Regions.SP_STAR_CONNECTION, LocationGroups.SWITCH),
    Locations.SP_CRYSTAL_BLOCKS: AstalonLocationData(Regions.SP_START, LocationGroups.SWITCH),
    Locations.SP_CRYSTAL_STAR: AstalonLocationData(Regions.SP_SHAFT, LocationGroups.SWITCH),
