...
location_table: Dict[Locations, AstalonLocationData] = {
    Locations.GT_GORGONHEART: AstalonLocationData(Regions.GT_GORGONHEART, LocationGroups.ITEMS),
    Locations.GT_ANCIENTS_RING: AstalonLocationData(Regions.GT_BOTTOM, LocationGroups.ITEMS),
    Locations.GT_SWORD: AstalonLocationData(Regions.GT_SWORD, LocationGroups.ITEMS),
    Locations.GT_MAP: AstalonLocationData(Regions.GT_BOTTOM, LocationGroups.ITEMS),
    Locations.GT_ASCENDANT_KEY: AstalonLocationData(Regions.GT_ASCENDANT_KEY, LocationGroups.ITEMS),
    Locations.GT_BANISH: AstalonLocationData(Regions.GT_LEFT, LocationGroups.ITEMS),
    Locations.GT_VOID: AstalonLocationData(Regions.GT_VOID, LocationGroups.ITEMS),
    ...
    Locations.GT_WHITE_KEY_START: AstalonLocationData(Regions.ENTRANCE, LocationGroups.KEYS_WHITE),
    Locations.GT_WHITE_KEY_RIGHT: AstalonLocationData(Regions.GT_BOTTOM, LocationGroups.KEYS_WHITE),
    Locations.GT_WHITE_KEY_BOSS: AstalonLocationData(Regions.GT_TOP_RIGHT, LocationGroups.KEYS_WHITE),
    Locations.GT_BLUE_KEY_BONESNAKE: AstalonLocationData(Regions.GT_BOTTOM, LocationGroups.KEYS_BLUE),
    Locations.GT_BLUE_KEY_BUTT: AstalonLocationData(Regions.GT_BUTT, LocationGroups.KEYS_BLUE),
    Locations.GT_BLUE_KEY_WALL: AstalonLocationData(Regions.GT_BUTT, LocationGroups.KEYS_BLUE),
    Locations.GT_BLUE_KEY_POT: AstalonLocationData(Regions.GT_UPPER_PATH, LocationGroups.KEYS_BLUE),
    Locations.GT_RED_KEY: AstalonLocationData(Regions.GT_BOSS, LocationGroups.KEYS_RED),
    Locations.MECH_BOOTS: AstalonLocationData(Regions.MECH_BOOTS_UPPER, LocationGroups.ITEMS),
    Locations.MECH_CLOAK: AstalonLocationData(Regions.MECH_CLOAK, LocationGroups.ITEMS),
    Locations.MECH_EYE_BLUE: AstalonLocationData(Regions.MECH_BOSS, LocationGroups.ITEMS),
    ...
    Locations.MECH_WHITE_KEY_LINUS: AstalonLocationData(Regions.MECH_SWORD_CONNECTION, LocationGroups.KEYS_WHITE),
    Locations.MECH_WHITE_KEY_BK: AstalonLocationData(Regions.MECH_AFTER_BK, LocationGroups.KEYS_WHITE),
    Locations.MECH_WHITE_KEY_ARENA: AstalonLocationData(Regions.MECH_RIGHT, LocationGroups.KEYS_WHITE),
    Locations.MECH_WHITE_KEY_TOP: AstalonLocationData(Regions.MECH_TOP, LocationGroups.KEYS_WHITE),
    Locations.MECH_BLUE_KEY_VOID: AstalonLocationData(Regions.GT_VOID, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_SNAKE: AstalonLocationData(Regions.MECH_SNAKE, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_LINUS: AstalonLocationData(Regions.MECH_LOWER_ARIAS, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_SACRIFICE: AstalonLocationData(Regions.MECH_SACRIFICE, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_RED: AstalonLocationData(Regions.MECH_LOWER_VOID, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_ARIAS: AstalonLocationData(Regions.MECH_ARIAS_EYEBALL, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_BLOCKS: AstalonLocationData(Regions.MECH_CHAINS, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_TOP: AstalonLocationData(Regions.MECH_SPLIT_PATH, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_OLD_MAN: AstalonLocationData(Regions.MECH_RIGHT, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_SAVE: AstalonLocationData(Regions.MECH_TOP, LocationGroups.KEYS_BLUE),
    Locations.MECH_BLUE_KEY_POT: AstalonLocationData(Regions.MECH_POTS, LocationGroups.KEYS_BLUE),
    Locations.MECH_RED_KEY: AstalonLocationData(Regions.MECH_LOWER_VOID, LocationGroups.KEYS_RED),
    Locations.HOTP_BELL: AstalonLocationData(Regions.HOTP_BELL, LocationGroups.ITEMS),
    Locations.HOTP_AMULET: AstalonLocationData(Regions.HOTP_AMULET, LocationGroups.ITEMS),
    Locations.HOTP_CLAW: AstalonLocationData(Regions.HOTP_CLAW, LocationGroups.ITEMS),
    Locations.HOTP_GAUNTLET: AstalonLocationData(Regions.HOTP_GAUNTLET, LocationGroups.ITEMS),
    Locations.HOTP_MAIDEN_RING: AstalonLocationData(Regions.HOTP_MAIDEN, LocationGroups.ITEMS),
    ...
    Locations.HOTP_WHITE_KEY_LEFT: AstalonLocationData(Regions.HOTP_START_LEFT, LocationGroups.KEYS_WHITE),
    Locations.HOTP_WHITE_KEY_GHOST: AstalonLocationData(Regions.HOTP_LOWER, LocationGroups.KEYS_WHITE),
    Locations.HOTP_WHITE_KEY_OLD_MAN: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.KEYS_WHITE),
    Locations.HOTP_WHITE_KEY_BOSS: AstalonLocationData(Regions.HOTP_UPPER_ARIAS, LocationGroups.KEYS_WHITE),
    Locations.HOTP_BLUE_KEY_STATUE: AstalonLocationData(Regions.HOTP_EPIMETHEUS, LocationGroups.KEYS_BLUE),
    Locations.HOTP_BLUE_KEY_GOLD: AstalonLocationData(Regions.HOTP_LOWER, LocationGroups.KEYS_BLUE),
    Locations.HOTP_BLUE_KEY_AMULET: AstalonLocationData(Regions.HOTP_AMULET_CONNECTION, LocationGroups.KEYS_BLUE),
    Locations.HOTP_BLUE_KEY_LADDER: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.KEYS_BLUE),
    Locations.HOTP_BLUE_KEY_TELEPORTS: AstalonLocationData(Regions.HOTP_ELEVATOR, LocationGroups.KEYS_BLUE),
    Locations.HOTP_BLUE_KEY_MAZE: AstalonLocationData(Regions.HOTP_TP_PUZZLE, LocationGroups.KEYS_BLUE),
    Locations.HOTP_RED_KEY: AstalonLocationData(Regions.HOTP_RED_KEY, LocationGroups.KEYS_RED),
    Locations.ROA_ICARUS: AstalonLocationData(Regions.ROA_ICARUS, LocationGroups.ITEMS),
    Locations.ROA_EYE_GREEN: AstalonLocationData(Regions.ROA_BOSS, LocationGroups.ITEMS),
    ...
    Locations.ROA_WHITE_KEY_SAVE: AstalonLocationData(Regions.ROA_WORMS, LocationGroups.KEYS_WHITE),
    Locations.ROA_WHITE_KEY_REAPERS: AstalonLocationData(Regions.ROA_BOTTOM_ASCEND, LocationGroups.KEYS_WHITE),
    Locations.ROA_WHITE_KEY_TORCHES: AstalonLocationData(Regions.ROA_MIDDLE, LocationGroups.KEYS_WHITE),
    Locations.ROA_WHITE_KEY_PORTAL: AstalonLocationData(Regions.ROA_UPPER_VOID, LocationGroups.KEYS_WHITE),
    Locations.ROA_BLUE_KEY_FACE: AstalonLocationData(Regions.ROA_BOTTOM_ASCEND, LocationGroups.KEYS_BLUE),
    Locations.ROA_BLUE_KEY_FLAMES: AstalonLocationData(Regions.ROA_FLAMES, LocationGroups.KEYS_BLUE),
    Locations.ROA_BLUE_KEY_BABY: AstalonLocationData(Regions.ROA_LEFT_BABY_GORGON, LocationGroups.KEYS_BLUE),
    Locations.ROA_BLUE_KEY_TOP: AstalonLocationData(Regions.ROA_CENTAUR, LocationGroups.KEYS_BLUE),
    Locations.ROA_BLUE_KEY_POT: AstalonLocationData(Regions.ROA_BOTTOM_ASCEND, LocationGroups.KEYS_BLUE),
    Locations.ROA_RED_KEY: AstalonLocationData(Regions.ROA_RED_KEY, LocationGroups.KEYS_RED),
    Locations.DARK_HP_4: AstalonLocationData(Regions.DARK_END, LocationGroups.HEALTH),
    Locations.DARK_WHITE_KEY: AstalonLocationData(Regions.DARK_END, LocationGroups.KEYS_WHITE),
    Locations.APEX_CHALICE: AstalonLocationData(Regions.APEX_CENTAUR, LocationGroups.ITEMS),
    ...
    Locations.CATA_BOW: AstalonLocationData(Regions.CATA_BOW, LocationGroups.ITEMS),
    ...
    Locations.CATA_WHITE_KEY_HEAD: AstalonLocationData(Regions.CATA_TOP, LocationGroups.KEYS_WHITE),
    Locations.CATA_WHITE_KEY_DEV_ROOM: AstalonLocationData(Regions.CATA_DEV_ROOM_CONNECTION, LocationGroups.KEYS_WHITE),
    Locations.CATA_WHITE_KEY_PRISON: AstalonLocationData(Regions.CATA_BOSS, LocationGroups.KEYS_WHITE),
    Locations.CATA_BLUE_KEY_SLIMES: AstalonLocationData(Regions.CATA_BOW_CAMPFIRE, LocationGroups.KEYS_BLUE),
    Locations.CATA_BLUE_KEY_EYEBALLS: AstalonLocationData(Regions.CATA_CENTAUR, LocationGroups.KEYS_BLUE),
    Locations.TR_ADORNED_KEY: AstalonLocationData(Regions.TR_BOTTOM, LocationGroups.ITEMS),
    ...
    Locations.TR_RED_KEY: AstalonLocationData(Regions.TR_START, LocationGroups.KEYS_RED),
    ...
    Locations.CATH_BLOCK: AstalonLocationData(Regions.CATH_TOP, LocationGroups.ITEMS),
    ...
    Locations.SP_STAR: AstalonLocationData(Regions.SP_STAR, LocationGroups.ITEMS),
    ...
    Locations.SP_BLUE_KEY_BUBBLES: AstalonLocationData(Regions.SP_START, LocationGroups.KEYS_BLUE),
    Locations.SP_BLUE_KEY_STAR: AstalonLocationData(Regions.SP_STAR_END, LocationGroups.KEYS_BLUE),
    Locations.SP_BLUE_KEY_PAINTING: AstalonLocationData(Regions.SP_PAINTING, LocationGroups.KEYS_BLUE),
    Locations.SP_BLUE_KEY_ARIAS: AstalonLocationData(Regions.SP_CAMPFIRE_2, LocationGroups.KEYS_BLUE),
    ...
    Locations.GT_ALGUS: AstalonLocationData(Regions.ENTRANCE, LocationGroups.CHARACTERS),
    Locations.GT_ARIAS: AstalonLocationData(Regions.ENTRANCE, LocationGroups.CHARACTERS),
    Locations.GT_KYULI: AstalonLocationData(Regions.ENTRANCE, LocationGroups.CHARACTERS),
    Locations.MECH_ZEEK: AstalonLocationData(Regions.MECH_ZEEK, LocationGroups.CHARACTERS),
    Locations.TR_BRAM: AstalonLocationData(Regions.TR_BRAM, LocationGroups.CHARACTERS),
