...
ENTRANCE_RULES: Dict[Tuple[R, R], Callable[["AstalonRules", CollectionState], bool]] = {
    ...
    (R.CAVES_START, R.CAVES_STATUE): lambda rules, state: False,
    (R.CAVES_START, R.GT_BOTTOM): lambda rules, state: False,
    (R.CAVES_STATUE, R.CAVES_UPPER): lambda rules, state: False,
    (R.CAVES_STATUE, R.CAVES_START): lambda rules, state: False,
    (R.CAVES_UPPER, R.CAVES_STATUE): lambda rules, state: False,
