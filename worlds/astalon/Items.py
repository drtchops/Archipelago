...
item_table: Dict[str, AstalonItemData] = {
    ...
    Crystal.GT_OLD_MAN_2.value: AstalonItemData(ItemClassification.progression, 1, ItemGroups.SWITCH),
    ...
    Crystal.MECH_OLD_MAN.value: AstalonItemData(ItemClassification.progression, 1, ItemGroups.SWITCH),
    ...
    Face.HOTP_OLD_MAN.value: AstalonItemData(ItemClassification.progression, 1, ItemGroups.SWITCH),
