...
astalon_regions: Dict[Regions, Set[Regions]] = {
    ...
    Regions.MECH_UPPER: {Regions.HOTP_START, Regions.HOTP_LOWER, Regions.HOTP_UPPER, Regions.CD},
    Regions.HOTP_BOTTOM: {Regions.HOTP_LOWER},
    Regions.HOTP_LOWER: {Regions.HOTP_START, Regions.HOTP_BELL, Regions.MECH_LOWER, Regions.MECH_UPPER},
    Regions.HOTP_START: {Regions.HOTP_UPPER, Regions.HOTP_LOWER},
    Regions.HOTP_BELL: {Regions.HOTP_MID, Regions.CATH},
    Regions.HOTP_MID: {Regions.HOTP_UPPER, Regions.HOTP_BELL},
