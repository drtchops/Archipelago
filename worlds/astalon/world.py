...
class AstalonWorld(AstalonUTWorld):
    ...
    def create_regions(self) -> None:
        ...
        if not self.options.randomize_key_items:
            ...
            self.create_event(Events.BELL, LocationName.HOP_BELL)
            self.create_event(Events.CLAW, LocationName.HOP_CLAW)
            self.create_event(Events.GAUNTLET, LocationName.HOP_GAUNTLET)
